  ...
  import { sriLankaCities } from "@utils/sriLankaCities";
  ...
  const AddShippingAddress = () => {
    ...
    useEffect(() => {
      ...
      if (selectedValue?.country === "Sri Lanka") {
        setCityOptions(sriLankaCities.map(city => ({ name: city })));
      } else {
        setCityOptions(cities);
      }
    }, [selectedValue?.country, cities]);
                    ...
                    <div className="lg:mt-6 mt-4 bg-white">
                      <div className="grid grid-cols-6 gap-6">
                        ...
                        <div className="col-span-6 sm:col-span-3">
                          ...
                          />
                          {/* <p className="">{selectedValue?.city}</p> */}
